...
System.out.println("No of sleeper seats: " + noofsleeperseat);
    ...
    public void setData(int regdno, String model, int capacity, String owner, String from, String to, String depttime, String arrivaltime, booleanisAC, booleanisWifi, int noofsleeperseat) {
...
LuxuryPublicBusluxuryPublicBus = new LuxuryPublicBus();
